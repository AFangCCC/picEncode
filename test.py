from cv2 import IMREAD_GRAYSCALE, imshow, waitKey, destroyAllWindows,COLOR_BGR2GRAY,cvtColor
...
if __name__ == '__main__':
    ...
    src_img_path = r'C:\Users\afangccc\Desktop\excemple.jpg'  # 图片比较小
    # src_img_path = 'wallpaper.bmp' # 图片比较大

    # 即使原图像是灰度图，也需要加入GRAYSCALE标志
    src_img = imread(src_img_path)#, IMREAD_GRAYSCALE
    src_img = cvtColor(src_img, COLOR_BGR2GRAY)
    print(src_img.shape)
    # 记录原始图像的尺寸，后续还原图像要用到
